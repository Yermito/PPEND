        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    intro = False
        screen.fill(blue)
        message_to_screen("Welcome!",med_green,-150,size="large")
        message_to_screen("Have a good game",med_green,-50,size="medium")
...
def loading():
    font = pygame.font.SysFont("Arial",32)
    game_tip = font.render('Game is loading, please wait',1,(med_yellow))
    ...
    font1 = pygame.font.SysFont("comicsansms", int(screenheight//6))
    font1_render = font1.render('Tank Battle',1,(med_yellow))
    ...
    tank_curs = pygame.image.load('tanka.png').convert_alpha()
